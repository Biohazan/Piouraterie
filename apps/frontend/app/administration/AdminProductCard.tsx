...
const { mutate } = useMutation({
  ...
  return (
    <div className="flex flex-col w-56 h-80  rounded-lg items-center p-0 shadow-sm hover:shadow-xl hover:scale-105 outline-1 hover:outline transition-all shadow-indigo-100 bg-white">
      <Link
      ...
      >
        <Image
          ...
          className="h-[200px] overflow-hidden rounded-t-md object-cover"
          loading="lazy"
        />
        ...
        <div className="mx-2 mt-1">
          <dl>
            <div>
              ...
              <dd className="text-sm text-gray-500 font-bold w-52 overflow-hidden whitespace-nowrap text-ellipsis">
                {product.name}
              </dd>
            </div>

            <div className="mt-2">
              <dt className="sr-only text-xs">Description</dt>
              <dd className="font-medium block text-xs w-52 overflow-hidden whitespace-nowrap text-ellipsis">
                {product.describe}
              </dd>
            </div>
          </dl>
      ...
      <div className="mt-3 border-t grid grid-cols-2 gap-4 text-xs w-full">
        <div className="flex justify-around flex-row items-center sm:gap-2 mt-1">
