       ...
       {isError && <div>Une erreur est survenue</div>}
        ...
        <div className="flow-root m-6 shadow-sm w-full">
          ...
          <div className="grid grid-cols-1 gap-1 py-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
              ...
              <dd className="text-gray-700 sm:col-span-2">{data?.describe}</dd>
            </div>

            <div className="grid grid-cols-1 gap-1 py-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
              <dt className="pl-2 font-medium text-gray-900">Matière</dt>
              <dd className="text-gray-700 sm:col-span-2">{data?.material}</dd>
            </div>
            ...
            <div className="grid grid-cols-1 gap-1 py-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
              ...
              <dd className="text-gray-700 sm:col-span-2">{productsTitle[data?.category as keyof typeof productsTitle]}</dd>
            </div>
