...
const ProductCard = ({
  ...
  return (
    <Link
      href={`/product/${id}`}
      className="group h-72 relative block shadow-lg overflow-hidden cursor-pointer min-w-[230px] max-w-[256px]"
    >
      ...
      <div className="absolute inset-0 flex flex-col items-end justify-between ">
        ...
        <div className="flex flex-col w-full items-start backdrop-blur-md bg-black/20 p-1">
          <div className="flex justify-between items-center w-full px-2 gap-2">
            <h3 className="text-sm font-medium text-white overflow-hidden whitespace-nowrap text-ellipsis">
              {name}
            </h3>
            <p className="text-white text-xs rounded-xl ">{price}€</p>
          </div>
